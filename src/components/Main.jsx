...
function MealItem(props) {
  ...
  function handleAdd() {
    changeCountMeal(id, Number(count) + 1);
  }
  ...
  return (
    <div className="py-3 flex border-b border-b-black">
      ...
      <div className="p-2">
        <div
          className="bg-brown-primary inline-block float-right text-white mt-2 py-1 px-6 rounded-2xl font-bold hover:opacity-50 cursor-pointer"
          onClick={handleAdd}
        >
          +Add
        </div>
